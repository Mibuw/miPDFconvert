...
#if (!defined(MIMONITORLANG) || MIMONITORLANG == 0x0409)
L"\
...
miMonitor will search for the \"searchstring\" while choosing the filename,\n\
...
void UpdateCaption(HWND hDlg)
{
	...
	swprintf_s(szCaption, LENGTHOF(szCaption), L"miMonitor %s - %s", szVersionShort, szOldCaption);
